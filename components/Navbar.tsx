  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-50">
      <nav className="mx-auto max-w-[1320px] px-4 pt-4 md:px-6">
        <div className="flex h-[70px] items-center justify-between rounded-[20px] border border-white/15 bg-[#8FC4EA] px-4 shadow-[0_12px_35px_rgba(18,87,214,0.16)] md:px-6">
